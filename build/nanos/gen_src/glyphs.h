...
extern unsigned int const C_Mina_64px_colors[];
extern unsigned char const C_Mina_64px_bitmap[512];
#ifdef HAVE_BAGL
        #include "bagl.h"
        extern const bagl_icon_details_t C_Mina_64px;
...
extern unsigned char const C_icon_processing_bitmap[16];
#ifdef HAVE_BAGL
        #include "bagl.h"
...
extern unsigned int const C_mina_logo_colors[];
extern unsigned char const C_mina_logo_bitmap[32];
#ifdef HAVE_BAGL
        #include "bagl.h"
        extern const bagl_icon_details_t C_mina_logo;
